...
mod roundtrip_tests {
    ...
    fn scalar_values_error_serialization() -> Result<()> {
        let should_fail_on_seralize: Vec<ScalarValue> = vec![
            ...
            ScalarValue::List(
                Box::new(vec![
                    ScalarValue::Int16(0).to_null(),
                    ScalarValue::Float32(32.0),
                ]),
                Box::new(DataType::List(new_box_field("item", DataType::Int16, true))),
            ),
            ScalarValue::List(
                Box::new(vec![
                    ScalarValue::Float32(0.0).to_null(),
                    ScalarValue::Float32(32.0),
                ]),
                Box::new(DataType::List(new_box_field("item", DataType::Int16, true))),
            ),
            ScalarValue::List(
                Box::new(vec![
                    ScalarValue::Null(Box::new(DataType::List(new_box_field(
                        "level2",
                        DataType::Float32,
                        true,
                    )))),
    ...
    fn round_trip_scalar_values() -> Result<()> {
        let should_pass: Vec<ScalarValue> = vec![
            ...
            ScalarValue::Float32(1.0),
            ScalarValue::Float32(f32::MAX),
            ScalarValue::Float32(f32::MIN),
            ScalarValue::Float32(-2000.0),
            ScalarValue::Float64(1.0),
            ScalarValue::Float64(f64::MAX),
            ScalarValue::Float64(f64::MIN),
            ScalarValue::Float64(-2000.0),
            ...
            ScalarValue::Utf8(String::from("Test string   ")),
            ScalarValue::LargeUtf8(String::from("Test Large utf8")),
            ScalarValue::Date32(0),
            ScalarValue::Date32(i32::MAX),
            ScalarValue::TimestampNanosecond(0),
            ScalarValue::TimestampNanosecond(i64::MAX),
            ScalarValue::TimestampMicrosecond(0),
            ScalarValue::TimestampMicrosecond(i64::MAX),
            ScalarValue::TimestampMicrosecond(0).to_null(),
            ScalarValue::List(
                Box::new(vec![
                    ScalarValue::Float32(-213.1),
    ...
    fn roundtrip_null_scalar_values() -> Result<()> {
        let test_types = vec![
            ScalarValue::Boolean(false).to_null(),
            ScalarValue::Float32(0.0).to_null(),
            ScalarValue::Float64(0.0).to_null(),
            ScalarValue::Int8(0).to_null(),
            ScalarValue::Int16(0).to_null(),
            ScalarValue::Int32(0).to_null(),
            ScalarValue::Int64(0).to_null(),
            ScalarValue::UInt8(0).to_null(),
            ScalarValue::UInt16(0).to_null(),
            ScalarValue::UInt32(0).to_null(),
            ScalarValue::UInt64(0).to_null(),
            ScalarValue::Utf8("".into()).to_null(),
            ScalarValue::LargeUtf8("".into()).to_null(),
            ScalarValue::Date32(0).to_null(),
            ScalarValue::TimestampMicrosecond(0).to_null(),
            ScalarValue::TimestampNanosecond(0).to_null(),
