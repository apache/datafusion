...
# Load centralized tool versions (PRETTIER_VERSION, ...)
...
Instead, override `ExecutionPlan::metrics_documentation` on the operator,
or update an entry in `datafusion/physical-plan/src/metric_docs.rs` for
common metrics.
-->
