...
mod tests {
    ...
    async fn test_metadata_cache() -> Result<(), DataFusionError> {
        ...
        +-----------------------------------+-----------------+---------------------+------+------------------+
        | alltypes_plain.parquet            | 1851            | 8882                | 1    | page_index=false |
        | alltypes_tiny_pages.parquet       | 454233          | 269074              | 2    | page_index=true  |
        | lz4_raw_compressed_larger.parquet | 380836          | 1339                | 1    | page_index=false |
        +-----------------------------------+-----------------+---------------------+------+------------------+
        ");
        ...
        | filename                          | file_size_bytes | metadata_size_bytes | hits | extra            |
        +-----------------------------------+-----------------+---------------------+------+------------------+
        | alltypes_plain.parquet            | 1851            | 8882                | 4    | page_index=false |
        | alltypes_tiny_pages.parquet       | 454233          | 269074              | 2    | page_index=true  |
