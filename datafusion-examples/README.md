...
| literal_guarantee_filter_pushdown | [`custom_data_source/literal_guarantee_filter_pushdown.rs`](examples/custom_data_source/literal_guarantee_filter_pushdown.rs) | Filter pushdown using LiteralGuarantee with a custom index                                                          |
| pruning_predicate_filter_pushdown | [`custom_data_source/pruning_predicate_filter_pushdown.rs`](examples/custom_data_source/pruning_predicate_filter_pushdown.rs) | Filter pushdown using PruningPredicate with partition statistics                                                    |
