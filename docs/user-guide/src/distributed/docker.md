...
docker run --network=host \
  -d ballistacompute/ballista-rust:0.6.0 \
...
59452ce72138   ballistacompute/ballista-rust:0.6.0   "/scheduler --bind-p…"   6 seconds ago   Up 5 seconds             affectionate_hofstadter
```
...
[2021-02-14T18:32:20Z INFO  scheduler] Ballista v0.6.0 Scheduler listening on 0.0.0.0:50050
```
...
$ docker ps
CONTAINER ID   IMAGE                                         COMMAND                  CREATED         STATUS         PORTS     NAMES
0746ce262a19   ballistacompute/ballista-rust:0.6.0   "/executor --externa…"   2 seconds ago   Up 1 second              naughty_mclean
59452ce72138   ballistacompute/ballista-rust:0.6.0   "/scheduler --bind-p…"   4 minutes ago   Up 4 minutes             affectionate_hofstadter
```
...
[2021-02-14T18:36:25Z INFO  executor] Ballista v0.6.0 Rust Executor listening on 0.0.0.0:50051
