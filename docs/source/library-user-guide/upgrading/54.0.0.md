...
Instead, it is created within the `CacheManager` and must be passed to `ListingTable`.

**Who is affected:**

- Users who want to limit the memory usage of the file statistics cache.
- Users who want to disable the file statistics.
- Users creating a `ListingTable` programmatically with a file statistics cache
