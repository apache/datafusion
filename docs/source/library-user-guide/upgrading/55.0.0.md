...
use datafusion_datasource::file_scan_config::{
    FileScanConfigBuilder, hash_partitioning_from_partition_fields,
};

let output_partitioning = hash_partitioning_from_partition_fields(
...
`hash_partitioning_from_partition_fields` returns
