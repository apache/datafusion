...
| DataFusion 54 settings                               | Equivalent DataFusion 55 settings                                                     |
| ---------------------------------------------------- | ------------------------------------------------------------------------------------- |
| `pushdown_filters = true`, `reorder_filters = true`  | `pushdown_filters = true`, `reorder_filters = true`, `pushdown_filter_mode = always`  |
| `pushdown_filters = true`, `reorder_filters = false` | `pushdown_filters = true`, `reorder_filters = false`, `pushdown_filter_mode = always` |

For example:

```sql
SET datafusion.execution.parquet.pushdown_filter_mode = always;
```

See [issue #3463](https://github.com/apache/datafusion/issues/3463) and
[PR #23420](https://github.com/apache/datafusion/pull/23420) for context.
