...
| Window    | A function that takes a row of data and returns a single value, but also has access to the rows around it. |
| Aggregate | A function that takes a group of rows and returns a single value.                                          |
