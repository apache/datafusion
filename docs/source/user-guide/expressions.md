...
| octet_length(text)                             | Returns number of bytes in the string or binary (`text`).                                                                                                                                                                                |
...
| approx_top_k(expr, k)                                                           | Returns the approximate `k` most frequent values for `expr`, ranked by estimated count with lower-error estimates preferred when counts tie.             |
