...
| Metric           | Description                                                                                                              |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------ |
| fetch_time       | Time spent executing the child operator and fetching batches.                                                            |
| repartition_time | Time spent performing repartitioning.                                                                                    |
| send_time        | Time spent sending output batches to output channels. One metric per output partition (labelled with `outputPartition`). |
