...
mod tests {
    ...
    fn simplify_inlist() {
        ...
        let subquery = Box::new(test_table_scan_with_name("test").unwrap());
        assert_eq!(
            simplify(in_list(
                col("c1"),
        ...
        let subquery1 =
            scalar_subquery(Box::new(test_table_scan_with_name("test1").unwrap()));
        let subquery2 =
            scalar_subquery(Box::new(test_table_scan_with_name("test2").unwrap()));
