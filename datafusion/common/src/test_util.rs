...
/// Shared test assertions for DataFusion crates. Not part of the supported public API.
...
/// # Public Only for Internal Use:
/// Array construction for test macros in DataFusion crates. Not part of the supported
/// public API.
/// See the [API health policy] for details.
///
/// [API health policy]: https://datafusion.apache.org/contributor-guide/api-health.html#datafusion-internal-public-apis
...
///
/// # Public Only for Internal Use:
/// Record batch construction for tests in DataFusion crates. Not part of the supported
/// public API.
/// See the [API health policy] for details.
///
/// [API health policy]: https://datafusion.apache.org/contributor-guide/api-health.html#datafusion-internal-public-apis
