...
config_namespace! {
    ...
    pub struct OptimizerOptions {
        ...
        /// Maximum size (in bytes) per partition for using InList pushdown in hash joins.
        ///
        /// When the build side of a hash join is smaller than this threshold, DataFusion will use
        /// InList-based filter pushdown rather than hash table lookup.
        ///
