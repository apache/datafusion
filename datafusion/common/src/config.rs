...
config_namespace! {
    ...
    pub struct OptimizerOptions {
        ...
        /// Dynamic filters can now prune additional join types based on preservation metadata, filtering only the
        /// non-preserved side (for example, the right side of a `LEFT JOIN`).
