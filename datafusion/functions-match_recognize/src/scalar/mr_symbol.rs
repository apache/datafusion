...
//! Internal helper UDF used by MATCH_RECOGNIZE to attach a symbol to an expression.
//!
//! This function returns its first argument unchanged at runtime. The second
//! argument carries the symbol name as a Utf8 literal for planning/rewrites.
