...
pub mod expr_fn {
    ...
    pub use super::scalar::{
        classifier, match_number, match_sequence_number, mr_is_excluded_row,
    };
    pub use super::windows::{mr_first, mr_last, mr_next, mr_prev};
}

/// Returns all default match_recognize scalar functions
pub fn all_default_match_recognize_scalar_functions() -> Vec<Arc<ScalarUDF>> {
    vec![
        scalar::mr_symbol(),
        scalar::match_number(),
        scalar::match_sequence_number(),
        scalar::classifier(),
        scalar::mr_is_excluded_row(),
    ]
}

/// Returns all default match_recognize aggregate functions
pub fn all_default_match_recognize_aggregate_functions() -> Vec<Arc<AggregateUDF>> {
    vec![aggregate::mr_first_udaf(), aggregate::mr_last_udaf()]
}

/// Returns all default match_recognize windowfunctions
pub fn all_default_match_recognize_window_functions() -> Vec<Arc<WindowUDF>> {
    vec![
...
pub fn register_all(
    ...
    let scalar_functions: Vec<Arc<ScalarUDF>> =
        all_default_match_recognize_scalar_functions();
    let aggregate_functions: Vec<Arc<AggregateUDF>> =
        all_default_match_recognize_aggregate_functions();
    let window_functions: Vec<Arc<WindowUDF>> =
        all_default_match_recognize_window_functions();
