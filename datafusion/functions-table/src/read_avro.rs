...
//! `read_avro` table function: reads Avro files as a table source.
//!
//! ```sql
//! SELECT * FROM read_avro('/path/to/file.avro')
//! SELECT * FROM read_avro('/path/to/dir/*.avro')
//! ```
...
pub struct ReadAvroFunc;

impl TableFunctionImpl for ReadAvroFunc {
    fn call_with_args(&self, args: TableFunctionArgs) -> Result<Arc<dyn TableProvider>> {
        ...
        let path = extract_path(&exprs[0], "read_avro")?;
