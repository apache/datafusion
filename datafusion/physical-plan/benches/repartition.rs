...
fn get_schema() -> SchemaRef {
    // Large schema with many columns
    ...
    Arc::new(Schema::new(vec![
        ...
        // Field::new_list("g", DataType::Utf8, true),
    ]))
}

fn get_infinite_stream() {
    let a = LazyMemoryExec::try_new()
}

fn bench_repartition_with(c: &mut Criterion) {
    let source = LazyMemoryExec::try_new()
