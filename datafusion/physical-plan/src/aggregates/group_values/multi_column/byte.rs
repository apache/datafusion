...
use arrow::{
    array::{
        Array, ArrayRef, AsArray, BufferBuilder, GenericBinaryArray, GenericStringArray,
        OffsetSizeTrait,
    },
    buffer::{OffsetBuffer, ScalarBuffer},
    datatypes::{ByteArrayType, DataType, GenericBinaryType},
};
use arrow_array::{types::GenericStringType, GenericByteArray};
...
use std::{mem::size_of, sync::Arc, vec};
...
#[cfg(test)]
mod tests {
    use super::ByteGroupValueBuilder;
