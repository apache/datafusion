...
impl BlockedGroupValuesBoolean {
...
impl BlockedGroupValues for BlockedGroupValuesBoolean {
...
mod tests {
    ...
    fn emit_all_splits_into_blocks() {
        let mut group_values = BlockedGroupValuesBoolean::new(2);
    ...
    fn emit_first_n_shifts_remaining() {
        let mut group_values = BlockedGroupValuesBoolean::new(4);
