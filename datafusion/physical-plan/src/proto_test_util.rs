...
pub(crate) mod registry_test_plan {
    ...
    use crate::proto::{
        ExecutionPlanDecodeCtx, ExecutionPlanEncodeCtx, ExecutionPlanFromProto,
    };
    use crate::{
    ...
    macro_rules! extension_plan {
        ($name:ident, $plan_name:literal) => {
                    ...
                    Ok(Some(PhysicalPlanNode {
                        physical_plan_type: Some(
                            datafusion_proto_models::protobuf::physical_plan_node::PhysicalPlanType::Extension(
                                datafusion_proto_models::protobuf::PhysicalExtensionNode {
                                    node: self.payload.as_bytes().to_vec(),
            ...
            impl ExecutionPlanFromProto for $name {
