...
pub trait ExecutionPlan: Debug + DisplayAs + Send + Sync {
    ...
    /// children.
    ///
    /// By default, the behavior of this method is similar to [`ExecutionPlan::with_new_children`]
    /// in that if `with_new_children` does not recompute plan properties, keeps dynamic filtering,
    /// or preserves other shared data, this method should follow the same behavior (except for
    /// updating the physical expressions).
    ///
    /// # Constraints
    ///
