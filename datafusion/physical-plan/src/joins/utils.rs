...
/// is used.
///
/// Public so that cost-based rules deriving join selectivity (such as the
/// physical optimizer's double star join reordering) share one definition of
/// NDV with the cardinality estimation here, rather than drifting from it.
