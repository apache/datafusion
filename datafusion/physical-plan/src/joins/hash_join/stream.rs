    ...
    fn process_probe_batch(
        ...
        if need_produce_result_in_final(self.join_type) {
            ...
            if self.join_type == JoinType::LeftSingle {
                ...
                // The visited bitmap is also used to detect duplicates, so this
                // catches matches spread over several probe batches and, with
                // `PartitionMode::CollectLeft`, over several partitions.
