...
impl RuntimeEnvBuilder {
    ...
    /// Specify a limit on the number of objects to store in the object list cache
    ...
    /// Specify the duration entries in the object list cache will be considered valid
