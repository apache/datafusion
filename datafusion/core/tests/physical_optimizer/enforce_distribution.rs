    ...
    for join_type in join_types {
        ...
        match join_type {
            ...
            | JoinType::LeftMark => {
                ...
                let top_join_plan_string = get_plan_string(&top_join).remove(0);
                let test_config = TestConfig::default();
                let (actual_1, actual_optimized_1) = test_config
                    .run_and_get_plan_string(top_join.clone(), &DISTRIB_DISTRIB_SORT)?;
                let (actual_2, actual_optimized_2) = test_config
