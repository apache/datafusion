...
async fn unnest_columns() -> Result<()> {
    ...
    let expected = [
        ...
        "+----------+--------------------------------------------------+--------------------------+",
        "| 1        | [{x: -4, y: 2}, {x: -8, y: 3}, {x: 6, y: -2}]    |                          |",
        "| 2        | [{x: 4, y: 3}, {x: -6, y: -10}, {x: -10, y: 9}]  | [tag1, tag2]             |",
        "| 3        |                                                  | [tag1, tag2, tag3, tag4] |",
        "| 4        | [{x: -2, y: -3}, {x: -5, y: -3}, {x: -10, y: 0}] |                          |",
        "+----------+--------------------------------------------------+--------------------------+",
    ];
    assert_batches_sorted_eq!(expected, &results);
    ...
    let expected = [
        ...
        "+----------+--------------------------------------------------+------+",
        "| 1        | [{x: -4, y: 2}, {x: -8, y: 3}, {x: 6, y: -2}]    |      |",
        "| 2        | [{x: 4, y: 3}, {x: -6, y: -10}, {x: -10, y: 9}]  | tag1 |",
        "| 2        | [{x: 4, y: 3}, {x: -6, y: -10}, {x: -10, y: 9}]  | tag2 |",
        "| 3        |                                                  | tag1 |",
        "| 3        |                                                  | tag2 |",
        "| 3        |                                                  | tag3 |",
        "| 3        |                                                  | tag4 |",
    ...
    let expected = [
        ...
        "| 1        | {x: -8, y: 3}   |                          |",
        "| 1        | {x: 6, y: -2}   |                          |",
        "| 2        | {x: -10, y: 9}  | [tag1, tag2]             |",
        "| 2        | {x: -6, y: -10} | [tag1, tag2]             |",
        "| 2        | {x: 4, y: 3}    | [tag1, tag2]             |",
        "| 3        |                 | [tag1, tag2, tag3, tag4] |",
        "| 4        | {x: -10, y: 0}  |                          |",
        "| 4        | {x: -2, y: -3}  |                          |",
...
async fn table_with_nested_types(n: usize) -> Result<DataFrame> {
    ...
    let mut rng = rand_chacha::ChaCha20Rng::seed_from_u64(197);
