...
async fn test_count_wildcard_on_window() -> Result<()> {
    ...
    |               |   BoundedWindowAggExec: wdw=[{field: Field { name: "count(Int64(1)) ORDER BY [t1.a DESC NULLS FIRST] RANGE BETWEEN 6 PRECEDING AND 2 FOLLOWING", data_type: Int64, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} }, frame: RANGE BETWEEN 6 PRECEDING AND 2 FOLLOWING}], mode=[Sorted] |
