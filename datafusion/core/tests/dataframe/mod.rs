...
use datafusion_functions_aggregate::average::avg_distinct;
...
async fn aggregate() -> Result<()> {
    ...
    assert_snapshot!(
        ...
        @r"
    +----+-----------------------------+-----------------------------+-----------------------------+--------------------------------------+-----------------------------+-------------------------------+----------------------------------------+
    | c1 | min(aggregate_test_100.c12) | max(aggregate_test_100.c12) | avg(aggregate_test_100.c12) | avg(DISTINCT aggregate_test_100.c12) | sum(aggregate_test_100.c12) | count(aggregate_test_100.c12) | count(DISTINCT aggregate_test_100.c12) |
    +----+-----------------------------+-----------------------------+-----------------------------+--------------------------------------+-----------------------------+-------------------------------+----------------------------------------+
    | a  | 0.02182578039211991         | 0.9800193410444061          | 0.48754517466109415         | 0.48754517466109415                  | 10.238448667882977          | 21                            | 21                                     |
    | b  | 0.04893135681998029         | 0.9185813970744787          | 0.41040709263815384         | 0.41040709263815384                  | 7.797734760124923           | 19                            | 19                                     |
    | c  | 0.0494924465469434          | 0.991517828651004           | 0.6600456536439784          | 0.6600456536439784                   | 13.860958726523545          | 21                            | 21                                     |
    | d  | 0.061029375346466685        | 0.9748360509016578          | 0.48855379387549824         | 0.48855379387549824                  | 8.793968289758968           | 18                            | 18                                     |
    | e  | 0.01479305307777301         | 0.9965400387585364          | 0.48600669271341534         | 0.48600669271341534                  | 10.206140546981722          | 21                            | 21                                     |
    +----+-----------------------------+-----------------------------+-----------------------------+--------------------------------------+-----------------------------+-------------------------------+----------------------------------------+
    "
    );
    ...
    let df = aggregates_table(&ctx)
        ...
        .aggregate(
            ...
            vec![
                ...
                avg_distinct(col("c3")).alias("avg_distinct_c3"),
            ],
        )?
        .sort(vec![
            Sort::new(col("c1"), false, true),
