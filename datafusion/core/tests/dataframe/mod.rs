...
async fn union_with_mix_of_presorted_and_explicitly_resorted_inputs_with_repartition_sorts_true() -> Result<()> {
    ...
    //
    //
    // === Full verbose explain ===
    //
    // +------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    // | plan_type                                                  | plan                                                                                                                                                                                                                                                                                                                                        |
    // +------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    // | initial_logical_plan                                       | Aggregate: groupBy=[[id]], aggr=[[]]                                                                                                                                                                                                                                                                                                        |
    // |                                                            |   Union                                                                                                                                                                                                                                                                                                                                     |
    // |                                                            |     Projection: sorted.id                                                                                                                                                                                                                                                                                                                   |
    // |                                                            |       TableScan: sorted                                                                                                                                                                                                                                                                                                                     |
    // |                                                            |     Sort: unsorted.id ASC NULLS LAST                                                                                                                                                                                                                                                                                                        |
    // |                                                            |       Projection: unsorted.id                                                                                                                                                                                                                                                                                                               |
    // |                                                            |         TableScan: unsorted                                                                                                                                                                                                                                                                                                                 |
    ...
    // | logical_plan after optimize_projections                    | Aggregate: groupBy=[[id]], aggr=[[]]                                                                                                                                                                                                                                                                                                        |
    // |                                                            |   Union                                                                                                                                                                                                                                                                                                                                     |
    // |                                                            |     TableScan: sorted projection=[id]                                                                                                                                                                                                                                                                                                       |
    // |                                                            |     Sort: unsorted.id ASC NULLS LAST                                                                                                                                                                                                                                                                                                        |
    // |                                                            |       TableScan: unsorted projection=[id]                                                                                                                                                                                                                                                                                                   |
    ...
    // |                                                            |         DataSourceExec: file_groups={1 group: [[{testdata}/alltypes_tiny_pages.parquet]]}, projection=[id], file_type=parquet                                                                                                                                                                    |
    // |                                                            |                                                                                                                                                                                                                                                                                                                                             |
    // | initial_physical_plan_with_stats                           | AggregateExec: mode=Final, gby=[id@0 as id], aggr=[], ordering_mode=Sorted, statistics=[Rows=Inexact(14600), Bytes=Absent, [(Col[0]: Min=Exact(Int32(0)) Max=Exact(Int32(7299)))]]                                                                                                                                                          |
    // |                                                            |   AggregateExec: mode=Partial, gby=[id@0 as id], aggr=[], ordering_mode=Sorted, statistics=[Rows=Inexact(14600), Bytes=Absent, [(Col[0]: Min=Exact(Int32(0)) Max=Exact(Int32(7299)))]]                                                                                                                                                      |
    // |                                                            |     UnionExec, statistics=[Rows=Exact(14600), Bytes=Exact(647158), [(Col[0]: Min=Exact(Int32(0)) Max=Exact(Int32(7299)) Null=Exact(0))]]                                                                                                                                                                                                    |
    // |                                                            |       DataSourceExec: file_groups={1 group: [[{testdata}/alltypes_tiny_pages.parquet]]}, projection=[id], output_ordering=[id@0 ASC NULLS LAST], file_type=parquet, statistics=[Rows=Exact(7300), Bytes=Exact(323579), [(Col[0]: Min=Exact(Int32(0)) Max=Exact(Int32(7299)) Null=Exact(0))]]     |
    // |                                                            |       SortExec: expr=[id@0 ASC NULLS LAST], preserve_partitioning=[false], statistics=[Rows=Exact(7300), Bytes=Exact(323579), [(Col[0]: Min=Exact(Int32(0)) Max=Exact(Int32(7299)) Null=Exact(0))]]                                                                                                                                         |
    // |                                                            |         DataSourceExec: file_groups={1 group: [[{testdata}/alltypes_tiny_pages.parquet]]}, projection=[id], file_type=parquet, statistics=[Rows=Exact(7300), Bytes=Exact(323579), [(Col[0]: Min=Exact(Int32(0)) Max=Exact(Int32(7299)) Null=Exact(0))]]                                          |
    // |                                                            |                                                                                                                                                                                                                                                                                                                                             |
    // | initial_physical_plan_with_schema                          | AggregateExec: mode=Final, gby=[id@0 as id], aggr=[], ordering_mode=Sorted, schema=[id:Int32;N]                                                                                                                                                                                                                                             |
    // |                                                            |   AggregateExec: mode=Partial, gby=[id@0 as id], aggr=[], ordering_mode=Sorted, schema=[id:Int32;N]                                                                                                                                                                                                                                         |
    // |                                                            |     UnionExec, schema=[id:Int32;N]                                                                                                                                                                                                                                                                                                          |
    // |                                                            |       DataSourceExec: file_groups={1 group: [[{testdata}/alltypes_tiny_pages.parquet]]}, projection=[id], output_ordering=[id@0 ASC NULLS LAST], file_type=parquet, schema=[id:Int32;N]                                                                                                          |
    // |                                                            |       SortExec: expr=[id@0 ASC NULLS LAST], preserve_partitioning=[false], schema=[id:Int32;N]                                                                                                                                                                                                                                              |
    // |                                                            |         DataSourceExec: file_groups={1 group: [[{testdata}/alltypes_tiny_pages.parquet]]}, projection=[id], file_type=parquet, schema=[id:Int32;N]                                                                                                                                               |
    // |                                                            |                                                                                                                                                                                                                                                                                                                                             |
    ...
    // | physical_plan after OutputRequirements                     | AggregateExec: mode=Final, gby=[id@0 as id], aggr=[], ordering_mode=Sorted                                                                                                                                                                                                                                                                  |
    // |                                                            |   SortPreservingMergeExec: [id@0 ASC NULLS LAST]                                                                                                                                                                                                                                                                                            |
    // |                                                            |     SortExec: expr=[id@0 ASC NULLS LAST], preserve_partitioning=[true]                                                                                                                                                                                                                                                                      |
    // |                                                            |       AggregateExec: mode=Partial, gby=[id@0 as id], aggr=[]                                                                                                                                                                                                                                                                                |
    // |                                                            |         UnionExec                                                                                                                                                                                                                                                                                                                           |
    ...
    // |                                                            |           DataSourceExec: file_groups={1 group: [[{testdata}/alltypes_tiny_pages.parquet]]}, projection=[id], file_type=parquet                                                                                                                                                                  |
    // |                                                            |                                                                                                                                                                                                                                                                                                                                             |
    // | physical_plan_with_stats                                   | AggregateExec: mode=Final, gby=[id@0 as id], aggr=[], ordering_mode=Sorted, statistics=[Rows=Inexact(14600), Bytes=Absent, [(Col[0]: Min=Exact(Int32(0)) Max=Exact(Int32(7299)))]]                                                                                                                                                          |
    // |                                                            |   SortPreservingMergeExec: [id@0 ASC NULLS LAST], statistics=[Rows=Inexact(14600), Bytes=Absent, [(Col[0]: Min=Exact(Int32(0)) Max=Exact(Int32(7299)))]]                                                                                                                                                                                    |
    // |                                                            |     SortExec: expr=[id@0 ASC NULLS LAST], preserve_partitioning=[true], statistics=[Rows=Inexact(14600), Bytes=Absent, [(Col[0]: Min=Exact(Int32(0)) Max=Exact(Int32(7299)))]]                                                                                                                                                              |
    // |                                                            |       AggregateExec: mode=Partial, gby=[id@0 as id], aggr=[], statistics=[Rows=Inexact(14600), Bytes=Absent, [(Col[0]: Min=Exact(Int32(0)) Max=Exact(Int32(7299)))]]                                                                                                                                                                        |
    // |                                                            |         UnionExec, statistics=[Rows=Exact(14600), Bytes=Exact(647158), [(Col[0]: Min=Exact(Int32(0)) Max=Exact(Int32(7299)) Null=Exact(0))]]                                                                                                                                                                                                |
    // |                                                            |           DataSourceExec: file_groups={1 group: [[{testdata}/alltypes_tiny_pages.parquet]]}, projection=[id], output_ordering=[id@0 ASC NULLS LAST], file_type=parquet, statistics=[Rows=Exact(7300), Bytes=Exact(323579), [(Col[0]: Min=Exact(Int32(0)) Max=Exact(Int32(7299)) Null=Exact(0))]] |
    // |                                                            |           DataSourceExec: file_groups={1 group: [[{testdata}/alltypes_tiny_pages.parquet]]}, projection=[id], file_type=parquet, statistics=[Rows=Exact(7300), Bytes=Exact(323579), [(Col[0]: Min=Exact(Int32(0)) Max=Exact(Int32(7299)) Null=Exact(0))]]                                        |
    // |                                                            |                                                                                                                                                                                                                                                                                                                                             |
    // | physical_plan_with_schema                                  | AggregateExec: mode=Final, gby=[id@0 as id], aggr=[], ordering_mode=Sorted, schema=[id:Int32;N]                                                                                                                                                                                                                                             |
    // |                                                            |   SortPreservingMergeExec: [id@0 ASC NULLS LAST], schema=[id:Int32;N]                                                                                                                                                                                                                                                                       |
    // |                                                            |     SortExec: expr=[id@0 ASC NULLS LAST], preserve_partitioning=[true], schema=[id:Int32;N]                                                                                                                                                                                                                                                 |
    // |                                                            |       AggregateExec: mode=Partial, gby=[id@0 as id], aggr=[], schema=[id:Int32;N]                                                                                                                                                                                                                                                           |
    // |                                                            |         UnionExec, schema=[id:Int32;N]                                                                                                                                                                                                                                                                                                      |
    // |                                                            |           DataSourceExec: file_groups={1 group: [[{testdata}/alltypes_tiny_pages.parquet]]}, projection=[id], output_ordering=[id@0 ASC NULLS LAST], file_type=parquet, schema=[id:Int32;N]                                                                                                      |
    // |                                                            |           DataSourceExec: file_groups={1 group: [[{testdata}/alltypes_tiny_pages.parquet]]}, projection=[id], file_type=parquet, schema=[id:Int32;N]                                                                                                                                             |
    // |                                                            |                                                                                                                                                                                                                                                                                                                                             |
