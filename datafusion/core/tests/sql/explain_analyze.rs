...
async fn csv_explain_plans() {
    ...
    // With filter pushdown, projection and filters are now on the TableScan
    assert_contains!(&actual, "projection=[c1]");
    assert_contains!(actual, "aggregate_test_100.c2 > Int8(10)");
}
