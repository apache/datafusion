...
async fn test_accumulator_row_accumulator() -> Result<()> {
    ...
    let sql =
        "SELECT c1, c2, MIN(c13), MIN(c9), MAX(c13), MAX(c9), AVG(c9), MIN(c13) as min1, COUNT(C9)
    FROM aggregate_test_100 GROUP BY c1, c2
    ORDER BY c1, c2";

    // let sql =
    //     "SELECT c1, c2, MIN(c13)
    // FROM aggregate_test_100 GROUP BY c1, c2
    // ORDER BY c1, c2";
    ...
    let expected = vec![
        "+----+----+--------------------------------+----------------------------+--------------------------------+----------------------------+----------------------------+--------------------------------+------------------------------+",
        "| c1 | c2 | MIN(aggregate_test_100.c13)    | MIN(aggregate_test_100.c9) | MAX(aggregate_test_100.c13)    | MAX(aggregate_test_100.c9) | AVG(aggregate_test_100.c9) | min1                           | COUNT(aggregate_test_100.c9) |",
        "+----+----+--------------------------------+----------------------------+--------------------------------+----------------------------+----------------------------+--------------------------------+------------------------------+",
        "| a  | 1  | 0keZ5G8BffGwgF2RwQD59TFzMStxCB | 774637006                  | waIGbOGl1PM6gnzZ4uuZt4E2yDWRHs | 4015442341                 | 2437927011                 | 0keZ5G8BffGwgF2RwQD59TFzMStxCB | 5                            |",
        "| a  | 2  | b3b9esRhTzFEawbs6XhpKnD9ojutHB | 145294611                  | ukyD7b0Efj7tNlFSRmzZ0IqkEzg2a8 | 3717551163                 | 2267588664                 | b3b9esRhTzFEawbs6XhpKnD9ojutHB | 3                            |",
        "| a  | 3  | Amn2K87Db5Es3dFQO9cw9cvpAM6h35 | 431948861                  | oLZ21P2JEDooxV1pU31cIxQHEeeoLu | 3998790955                 | 2225685115.1666665         | Amn2K87Db5Es3dFQO9cw9cvpAM6h35 | 6                            |",
        "| a  | 4  | KJFcmTVjdkCMv94wYCtfHMFhzyRsmH | 466439833                  | ydkwycaISlYSlEq3TlkS2m15I2pcp8 | 2502326480                 | 1655431654                 | KJFcmTVjdkCMv94wYCtfHMFhzyRsmH | 4                            |",
        "| a  | 5  | MeSTAXq8gVxVjbEjgkvU9YLte0X9uE | 141047417                  | QJYm7YRA3YetcBHI5wkMZeLXVmfuNy | 2496054700                 | 1216992989.6666667         | MeSTAXq8gVxVjbEjgkvU9YLte0X9uE | 3                            |",
        "| b  | 1  | 6FPJlLAcaQ5uokyOWZ9HGdLZObFvOZ | 1842680163                 | akiiY5N0I44CMwEnBL6RTBk7BRkxEj | 4076864659                 | 3064946272.6666665         | 6FPJlLAcaQ5uokyOWZ9HGdLZObFvOZ | 3                            |",
        "| b  | 2  | 802bgTGl6Bk5TlkPYYTxp5JkKyaYUA | 1098639440                 | okOkcWflkNXIy4R8LzmySyY1EC3sYd | 3455216719                 | 2446327455.25              | 802bgTGl6Bk5TlkPYYTxp5JkKyaYUA | 4                            |",
        "| b  | 3  | 6x93sxYioWuq5c9Kkk8oTAAORM7cH0 | 243203849                  | MXhhH1Var3OzzJCtI9VNyYvA0q8UyJ | 1538863055                 | 891033452                  | 6x93sxYioWuq5c9Kkk8oTAAORM7cH0 | 2                            |",
        "| b  | 4  | 52mKlRE3aHCBZtjECq6sY9OqVf8Dze | 326151275                  | mhjME0zBHbrK6NMkytMTQzOssOa1gF | 3570297463                 | 1819528986.6               | 52mKlRE3aHCBZtjECq6sY9OqVf8Dze | 5                            |",
        "| b  | 5  | ALuRhobVWbnQTTWZdSOk0iVe8oYFhW | 974297360                  | qnPOOmslCJaT45buUisMRnM0rc77EK | 3457053821                 | 2501141166.8               | ALuRhobVWbnQTTWZdSOk0iVe8oYFhW | 5                            |",
        "| c  | 1  | 2T3wSlHdEmASmO0xcXHnndkKEt6bz8 | 473294098                  | mzbkwXKrPeZnxg2Kn1LRF5hYSsmksS | 3766999078                 | 1721573913                 | 2T3wSlHdEmASmO0xcXHnndkKEt6bz8 | 4                            |",
        "| c  | 2  | 6WfVFBVGJSQb7FhA7E0lBwdvjfZnSW | 141680161                  | pLk3i59bZwd5KBZrI1FiweYTd5hteG | 3398507249                 | 1703503487.7142856         | 6WfVFBVGJSQb7FhA7E0lBwdvjfZnSW | 7                            |",
        "| c  | 3  | 6oIXZuIPIqEoPBvFmbt2Nxy3tryGUE | 1088543984                 | Ow5PGpfTm4dXCfTDsXAOTatXRoAydR | 3862393166                 | 2446807725.75              | 6oIXZuIPIqEoPBvFmbt2Nxy3tryGUE | 4                            |",
        "| c  | 4  | 8LIh0b6jmDGm87BmIyjdxNIpX4ugjD | 2306130875                 | t6fQUjJejPcjc04wHvHTPe55S65B4V | 3593959807                 | 3071416030.75              | 8LIh0b6jmDGm87BmIyjdxNIpX4ugjD | 4                            |",
        "| c  | 5  | RilTlL1tKkPOUFuzmLydHAVZwv1OGl | 1229567292                 | TTQUwpMNSXZqVBKAFvXu7OlWvKXJKX | 4268716378                 | 2749141835                 | RilTlL1tKkPOUFuzmLydHAVZwv1OGl | 2                            |",
        "| d  | 1  | 4HX6feIvmNXBN7XGqgO4YVBkhu8GDI | 225513085                  | y7C453hRWd4E7ImjNDWlpexB8nUqjh | 4216440507                 | 2580450640.857143          | 4HX6feIvmNXBN7XGqgO4YVBkhu8GDI | 7                            |",
        "| d  | 2  | 90gAtmGEeIqUTbo1ZrxCvWtsseukXC | 63044568                   | lqhzgLsXZ8JhtpeeUWWNbMz8PHI705 | 4061635107                 | 1708542649                 | 90gAtmGEeIqUTbo1ZrxCvWtsseukXC | 3                            |",
        "| d  | 3  | 1aOcrEGd0cOqZe2I5XBOm0nDcwtBZO | 1824517658                 | Z2sWcQr0qyCJRMHDpRy3aQr7PkHtkK | 2592330556                 | 2170129047.3333335         | 1aOcrEGd0cOqZe2I5XBOm0nDcwtBZO | 3                            |",
        "| d  | 4  | 0og6hSkhbX8AC1ktFS4kounvTzy8Vo | 811650497                  | f9ALCzwDAKmdu7Rk2msJaB1wxe5IBX | 3126475872                 | 1824106822                 | 0og6hSkhbX8AC1ktFS4kounvTzy8Vo | 3                            |",
        "| d  | 5  | C2GT5KVyOPZpgKVl110TyZO0NcJ434 | 1365198901                 | F7NSTjWvQJyBburN7CXRUlbgp2dIrA | 3373581039                 | 2369389970                 | C2GT5KVyOPZpgKVl110TyZO0NcJ434 | 2                            |",
        "| e  | 1  | LiEBxds3X0Uw0lxiYjDqrkAaAwoiIW | 2610290479                 | gpo8K5qtYePve6jyPt6xgJx4YOVjms | 4229654142                 | 3223641897.6666665         | LiEBxds3X0Uw0lxiYjDqrkAaAwoiIW | 3                            |",
        "| e  | 2  | BPtQMxnuSPpxMExYV9YkDa6cAN7GP3 | 1289293657                 | xipQ93429ksjNcXPX5326VSg1xJZcW | 4144173353                 | 2790023773                 | BPtQMxnuSPpxMExYV9YkDa6cAN7GP3 | 5                            |",
        "| e  | 3  | BsM5ZAYifRh5Lw3Y8X1r53I0cTJnfE | 559847112                  | pTeu0WMjBRTaNRT15rLCuEh3tBJVc5 | 3759340273                 | 2750454515.75              | BsM5ZAYifRh5Lw3Y8X1r53I0cTJnfE | 4                            |",
        "| e  | 4  | 0VVIHzxWtNOFLtnhjHEKjXaJOSLJfm | 28774375                   | oHJMNvWuunsIMIWFnYG31RCfkOo2V7 | 3521368277                 | 1809406350.142857          | 0VVIHzxWtNOFLtnhjHEKjXaJOSLJfm | 7                            |",
        "| e  | 5  | 56MZa5O1hVtX4c5sbnCfxuX5kDChqI | 662099130                  | gxfHWUF8XgY2KdFxigxvNEXe2V2XMl | 2861911482                 | 1762005306                 | 56MZa5O1hVtX4c5sbnCfxuX5kDChqI | 2                            |",
        "+----+----+--------------------------------+----------------------------+--------------------------------+----------------------------+----------------------------+--------------------------------+------------------------------+",
    ];
    assert_batches_eq!(expected, &actual);
