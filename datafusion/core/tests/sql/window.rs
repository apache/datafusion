...
#[tokio::test]
#[ignore]
async fn window_frame_groups_preceding_following_desc_v2() -> Result<()> {
    let ctx = SessionContext::new();
    register_aggregate_csv(&ctx).await?;
    let sql = "SELECT
        SUM(c9) OVER (ORDER BY c2, c3 GROUPS BETWEEN 7 PRECEDING AND 5 PRECEDING) as a13
        FROM aggregate_test_100
        ORDER BY c9
        LIMIT 5";
    let actual = execute_to_batches(&ctx, sql).await;
    let expected = vec![
        ...
        // "| a11        | a12         | a13        |",
        // "+------------+-------------+------------+",
        // "| 8762794441 | 23265575240 | 4216440507 |",
        // "| 9816952706 | 32247727190 | 4216440507 |",
        // "|            | 16948357027 | 4216440507 |",
        // "| 5488534936 | 35475180026 | 4216440507 |",
        // "| 4251998668 | 26703253620 | 4216440507 |",
        // "+------------+-------------+------------+",
        "+------------+-------------+-------------+",
        "| a11        | a12         | a13         |",
        "+------------+-------------+-------------+",
        "| 8762794441 | 23265575240 | 5838012327  |",
        "| 9816952706 | 32247727190 | 6763234295  |",
        "|            | 16948357027 | 7569829821  |",
        "| 5488534936 | 35475180026 | 12012095561 |",
        "| 4251998668 | 26703253620 | 12027257685 |",
        "+------------+-------------+-------------+",
    ];
    assert_batches_eq!(expected, &actual);
    Ok(())
