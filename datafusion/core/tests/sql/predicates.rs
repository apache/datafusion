...
where
   ...
   or
    ...
    let expected = vec![
        ...
        "    Inner Join: partsupp.ps_partkey = part.p_partkey [l_extendedprice:Decimal128(15, 2), l_discount:Decimal128(15, 2), p_partkey:Int64, ps_partkey:Int64, ps_suppkey:Int64]",
        ...
        "        Inner Join: part.p_partkey = lineitem.l_partkey [l_partkey:Int64, l_extendedprice:Decimal128(15, 2), l_discount:Decimal128(15, 2), p_partkey:Int64]",
