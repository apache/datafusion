...
//! For `AND`/`OR`, [`BinaryExpr`] can skip the right child for uniform left-child
//! results or evaluate it only on the rows that still need it. The skewed-hit
//! and single-row profiles exercise these short-circuit paths.
