...
pub trait ExecutionPlan: Debug + Send + Sync {
    ...
    /// Equivalence Propertie is a set of Columns that are known to have the same value in all tuples of this relation.
    /// Equivalence Propertie are generated by equality predicates, typically equijoin conditions and equality comparisons in filters.
