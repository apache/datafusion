...
mod tests {
                ...
                | JoinType::LeftAnti => {
                    ...
                    let expected = match join_type {
                        ...
                        JoinType::Inner | JoinType::Left | JoinType::LeftSemi | JoinType::LeftAnti => vec![
                            ...
                            "ParquetExec: file_groups={1 group: [[x]]}, projection=[a, b, c, d, e], limit=None, output_ordering=[]",
    ...
    fn merge_does_not_need_sort() -> Result<()> {
        ...
        let expected = &[
            ...
            "ParquetExec: file_groups={2 groups: [[x], [y]]}, projection=[a, b, c, d, e], limit=None, output_ordering=[a@0 ASC]",
        ];
