...
impl ParquetExec {
    ...
    pub fn with_enable_bloom_filter_on_read(mut self, enable_bloom_filter_on_read: bool) -> Self {
        self.table_parquet_options.global.bloom_filter_on_read_enabled = enable_bloom_filter_on_read;
        self
    }

    /// If enabled, the writer will write by the bloom filter
    pub fn with_enable_bloom_filter_on_write(mut self, enable_bloom_filter_on_write: bool) -> Self {
        self.table_parquet_options.global.bloom_filter_on_write_enabled = enable_bloom_filter_on_write;
        self
    }

    /// Return the value described in [`Self::with_enable_bloom_filter_on_read`]
    fn enable_bloom_filter_on_read(&self) -> bool {
        self.table_parquet_options.global.bloom_filter_on_read_enabled
    }
