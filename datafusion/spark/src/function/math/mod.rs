...
pub mod expr_fn {
    ...
    export_functions!((ceil, "Returns the smallest integer not less than expr.", arg1));
    ...
    export_functions!((isnan, "Returns true if expr is NaN, false otherwise (including for NULL).", arg1));
