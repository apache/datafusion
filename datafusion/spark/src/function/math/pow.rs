...
mod tests {
    ...
    fn call_scalar_pow(base: f64, exp: f64) -> f64 {
        ...
        let args = ScalarFunctionArgs {
            args: vec![
                ColumnarValue::Scalar(ScalarValue::Float64(Some(base))),
    ...
    #[test]
    fn test_spark_pow_zero_negative_returns_infinity() {
        // Spark: pow(0, -1) = Infinity  (IEEE 754)
        assert_eq!(call_scalar_pow(0.0, -1.0), f64::INFINITY);
        assert_eq!(call_scalar_pow(0.0, -0.5), f64::INFINITY);
        assert_eq!(call_scalar_pow(-0.0, -1.0), f64::INFINITY);
    }

    #[test]
    fn test_spark_pow_normal_cases() {
        assert_eq!(call_scalar_pow(2.0, 3.0), 8.0);
