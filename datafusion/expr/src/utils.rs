...
use crate::{
    and, Aggregate, BinaryExpr, Expr, ExprSchemable, Filter, GroupingSet, LogicalPlan,
    Operator,
};
...
impl DynamicJoinFilterPushdownInfo {
    ...
    pub fn push_aggregates(&mut self, aggs: Vec<Expr>) {
...
impl DynamicJoinFilterPushdownColumn {
    pub fn new(condition_idx: usize, column: Arc<Expr>) -> Self {
        Self {
            condition_idx,
            column,
        }
