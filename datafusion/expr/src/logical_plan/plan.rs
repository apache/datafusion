...
use crate::{
    ...
    MatchRecognize, Operator, Prepare, TableProviderFilterPushDown, TableSource,
        ...
        match self {
            ...
            LogicalPlan::MatchRecognize(match_recognize) => {
                ...
                let new_order_by: Vec<SortExpr> = expr_iter
                    ...
                    .collect();
                let new_defines: Vec<(Expr, String)> = expr_iter
                    .by_ref()
                    .take(defines_len)
                    .zip(match_recognize.defines.iter().map(|(_, s)| s.clone()))
                    .collect();

                Ok(LogicalPlan::MatchRecognize(
