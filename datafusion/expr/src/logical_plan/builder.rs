...
use datafusion_common::{
    exec_err, get_target_functional_dependencies, internal_datafusion_err, internal_err,
    not_impl_err, plan_datafusion_err, plan_err, Column, Constraints, DFSchema,
    DFSchemaRef, NullEquality, Result, ScalarValue, TableReference, ToDFSchema,
    UnnestOptions,
};
...
impl LogicalPlanBuilder {
    ...
    pub fn join_detailed_with_options_and_join_kind(
        self,
        right: LogicalPlan,
        join_type: JoinType,
        join_keys: (Vec<impl Into<Column>>, Vec<impl Into<Column>>),
