...
use datafusion_common::utils::{ListCoercion, coerced_fixed_size_list_to_list};
use datafusion_common::{
    Result, exec_err, internal_datafusion_err, internal_err, plan_err, types::NativeType,
    utils::list_ndims,
};
    ...
    fn array_valid_types(
        ...
        let Some(array_idx) = array_idx else {
            return Err(internal_datafusion_err!(
                "Function '{function_name}' expected at least one argument array argument"
            ));
        };
