...
mod noforce_hash_collisions {
    ...
    pub use ahash::{CallHasher, RandomState};
    use arrow::array::{Array, ArrayRef, DictionaryArray, DictionaryKey};
...
mod force_hash_collisions {
    ...
    pub fn create_hashes<'a>(
        _arrays: &[ArrayRef],
        _random_state: &super::RandomState,
        hashes_buffer: &'a mut Vec<u64>,
    ) -> Result<&'a mut Vec<u64>> {
...
#[cfg(feature = "force_hash_collisions")]
pub use force_hash_collisions::create_hashes;
