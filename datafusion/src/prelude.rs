...
pub use crate::logical_plan::{
    ...
    random, regexp_match, repeat, replace, reverse, right, rpad, rtrim, sha224, sha256,
    sha384, sha512, split_part, starts_with, strpos, substr, sum, to_hex, translate,
    trim, upper, Column, JoinType, Partitioning,
};
