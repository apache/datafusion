...
use arrow::temporal_conversions::as_datetime_with_timezone;
...
use DataType::{Null, Timestamp, Utf8};
...
impl DateTruncFunc {
    pub fn new() -> Self {
        Self {
            ...
            aliases: vec![String::from("date_trunc"), String::from("datetrunc")],
        }
    }
}
