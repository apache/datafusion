...
mod tests {
    ...
    fn test_functions() -> Result<()> {
        test_function!(
            InitcapFunc::new(),
            vec![ColumnarValue::from(ScalarValue::from("hi THOMAS"))],
            Ok(Some("Hi Thomas")),
            &str,
            Utf8,
            StringArray
        ...
        test_function!(
            InitcapFunc::new(),
            vec![ColumnarValue::from(ScalarValue::Utf8(Some(
        ...
        test_function!(
            InitcapFunc::new(),
            vec![ColumnarValue::from(ScalarValue::from(""))],
            Ok(Some("")),
            &str,
            Utf8,
            StringArray
        ...
        test_function!(
            InitcapFunc::new(),
            vec![ColumnarValue::from(ScalarValue::Utf8View(None))],
            Ok(None),
            &str,
            Utf8View,
            StringViewArray
