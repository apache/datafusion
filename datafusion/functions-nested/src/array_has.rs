...
use arrow::array::{
    as_fixed_size_list_array, Array, ArrayRef, BooleanArray, Datum, OffsetSizeTrait, Scalar
};
...
fn array_has_all_and_any_inner(args: &[ArrayRef], comparison_type: ComparisonType) -> Result<ArrayRef> {
