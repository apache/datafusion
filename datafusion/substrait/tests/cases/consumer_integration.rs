...
mod tests {
    ...
    async fn test_multiple_joins() -> Result<()> {
        ...
        assert_snapshot!(
            plan_str,
            @r#"
        Projection: left.count(Int64(1)) AS count_first, left.category, left.count(Int64(1)):1 AS count_second, right.count(Int64(1)) AS count(Int64(1))__temp__0 AS count_third
