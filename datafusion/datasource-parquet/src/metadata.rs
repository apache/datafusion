...
fn get_col_stats(
    ...
    column_avg_byte_sizes: &[Precision<usize>],
    ...
    (0..schema.fields().len())
        .map(|i| {
            ...
            ColumnStatistics {
                ...
                avg_byte_size: column_avg_byte_sizes[i],
            }
        })
        .collect()
}
...
mod tests {
    ...
    fn test_avg_byte_size_zero_rows() {
        ...
        assert_eq!(result.column_statistics[0].byte_size, Precision::Inexact(0));
