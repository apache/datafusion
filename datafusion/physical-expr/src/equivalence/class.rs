...
use crate::equivalence::{add_offset_to_expr, collapse_lex_req, ProjectionMapping};
...
impl EquivalenceClass {
    ...
    /// Returns true if this equivalence class contains the expression
...
impl EquivalenceGroup {
    ...
    /// Return the inner vector of equivalence classes
    pub fn into_vec(self) -> Vec<EquivalenceClass> {
        self.classes
    }
    ...
    pub fn remove_redundant_entries(&mut self) {
    ...
    pub fn bridge_classes(&mut self) {
        let mut idx = 0;
