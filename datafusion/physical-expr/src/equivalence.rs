...
pub struct OrderingEquivalenceProperties {
    classes: Vec<EquivalentClass<OrderedColumn>>,
    schema: SchemaRef,
}
...
impl OrderingEquivalenceProperties {
    ...
    pub fn classes(&self) -> &[EquivalentClass<OrderedColumn>] {
        &self.classes
    }
    ...
    pub fn extend<I: IntoIterator<Item = EquivalentClass<OrderedColumn>>>(
        &mut self,
        iter: I,
    ) {
        for ec in iter {
