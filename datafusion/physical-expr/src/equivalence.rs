...
impl From<EquivalentClass<Column>> for EquivalentClass<OrderedColumn> {
    fn from(value: EquivalentClass<Column>) -> Self {
        EquivalentClass {
    ...
    for (column, columns) in alias_map {
        ...
        if !find_match {
            let new_columns = columns
                ...
                .collect::<Vec<_>>();
            ec_classes.push(EquivalentClass::<OrderedColumn>::new(
                column.clone().into(),
                new_columns,
            ));
        }
