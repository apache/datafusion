...
mod tests {
    ...
    macro_rules! generic_decimal_to_other_test_cast {
        ($DECIMAL_ARRAY:ident, $A_TYPE:expr_2021, $TYPEARRAY:ident, $TYPE:expr_2021, $VEC:expr_2021,$CAST_OPTIONS:expr_2021) => {{
    ...
    macro_rules! generic_test_cast {
        ($A_ARRAY:ident, $A_TYPE:expr_2021, $A_VEC:expr_2021, $TYPEARRAY:ident, $TYPE:expr_2021, $VEC:expr_2021, $CAST_OPTIONS:expr_2021) => {{
            let schema = Schema::new(vec![Field::new("a", $A_TYPE, true)]);
