...
#[inline]
pub fn ts_second_interval_ym_op(
    ts_sec: i64,
    tz: &Option<Arc<str>>,
    array: &Arc<dyn Array>,
    sign: i32,
...
#[inline]
pub fn ts_second_interval_dt_op(
    ts_sec: i64,
    tz: &Option<Arc<str>>,
    array: &Arc<dyn Array>,
    sign: i32,
...
#[inline]
pub fn ts_second_interval_mdn_op(
    ts_sec: i64,
    tz: &Option<Arc<str>>,
    array: &Arc<dyn Array>,
    sign: i32,
