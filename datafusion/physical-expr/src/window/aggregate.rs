...
use datafusion_common::{
    Result, ScalarValue, assert_eq_or_internal_err, exec_datafusion_err,
};
...
impl WindowExpr for PlainAggregateWindowExpr {
    ...
    fn with_inner_expressions(
        ...
        assert_eq_or_internal_err!(
            expected_count,
            exprs_count,
            "Inconsistent number of physical expressions for PlainAggregateWindowExpr",
        );
        ...
        Ok(Arc::new(Self {
            ...
            is_constant_in_partition: self.is_constant_in_partition,
            filter,
        }))
    }
}
