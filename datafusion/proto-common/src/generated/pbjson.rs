...
impl serde::Serialize for ParquetOptions {
        ...
        S: serde::Serializer,
    {
        ...
        if self.field_id_enabled {
            struct_ser.serialize_field("fieldIdEnabled", &self.field_id_enabled)?;
        }
        if self.dictionary_page_size_limit != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl serde::de::Visitor<'_> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "fieldIdEnabled" | "field_id_enabled" => Ok(GeneratedField::FieldIdEnabled),
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut field_id_enabled__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::FieldIdEnabled => {
                            if field_id_enabled__.is_some() {
                                return Err(serde::de::Error::duplicate_field("fieldIdEnabled"));
                            }
                            field_id_enabled__ = Some(map_.next_value()?);
                        }
                ...
                Ok(ParquetOptions {
                    ...
                    field_id_enabled: field_id_enabled__.unwrap_or_default(),
