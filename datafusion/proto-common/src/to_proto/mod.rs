...
impl TryFrom<&ParquetOptions> for protobuf::ParquetOptions {
    ...
    fn try_from(value: &ParquetOptions) -> datafusion_common::Result<Self, Self::Error> {
        Ok(protobuf::ParquetOptions {
            ...
            filter_effectiveness_threshold_opt: Some(protobuf::parquet_options::FilterEffectivenessThresholdOpt::FilterEffectivenessThreshold(value.filter_effectiveness_threshold)),
        })
    }
}
