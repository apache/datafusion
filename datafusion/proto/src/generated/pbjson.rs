...
impl serde::Serialize for ShuffleWriterExecNode {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("datafusion.ShuffleWriterExecNode", len)?;
        if !self.job_id.is_empty() {
            struct_ser.serialize_field("jobId", &self.job_id)?;
        }
        if self.stage_id != 0 {
...
impl<'de> serde::Deserialize<'de> for ShuffleWriterExecNode {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ShuffleWriterExecNode;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct datafusion.ShuffleWriterExecNode")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<ShuffleWriterExecNode, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut job_id__ = None;
        ...
        deserializer.deserialize_struct("datafusion.ShuffleWriterExecNode", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for UnresolvedShuffleExecNode {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if self.output_partition_count != 0 {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("datafusion.UnresolvedShuffleExecNode", len)?;
        if self.stage_id != 0 {
            struct_ser.serialize_field("stageId", &self.stage_id)?;
        }
        if let Some(v) = self.schema.as_ref() {
        ...
        if self.input_partition_count != 0 {
            struct_ser.serialize_field("inputPartitionCount", &self.input_partition_count)?;
        }
        if self.output_partition_count != 0 {
            struct_ser.serialize_field("outputPartitionCount", &self.output_partition_count)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for UnresolvedShuffleExecNode {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "stageId" | "stage_id" => Ok(GeneratedField::StageId),
                            "schema" => Ok(GeneratedField::Schema),
                            "inputPartitionCount" | "input_partition_count" => Ok(GeneratedField::InputPartitionCount),
                            "outputPartitionCount" | "output_partition_count" => Ok(GeneratedField::OutputPartitionCount),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = UnresolvedShuffleExecNode;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct datafusion.UnresolvedShuffleExecNode")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<UnresolvedShuffleExecNode, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut stage_id__ = None;
                let mut schema__ = None;
                let mut input_partition_count__ = None;
                let mut output_partition_count__ = None;
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::StageId => {
                            if stage_id__.is_some() {
                        ...
                        GeneratedField::InputPartitionCount => {
                            if input_partition_count__.is_some() {
                                return Err(serde::de::Error::duplicate_field("inputPartitionCount"));
                            }
                            input_partition_count__ = 
                                Some(map.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        }
                        GeneratedField::OutputPartitionCount => {
                            if output_partition_count__.is_some() {
                                return Err(serde::de::Error::duplicate_field("outputPartitionCount"));
                            }
                            output_partition_count__ = 
                                Some(map.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        }
                    }
                }
                Ok(UnresolvedShuffleExecNode {
                    stage_id: stage_id__.unwrap_or_default(),
                    schema: schema__,
                    input_partition_count: input_partition_count__.unwrap_or_default(),
                    output_partition_count: output_partition_count__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("datafusion.UnresolvedShuffleExecNode", FIELDS, GeneratedVisitor)
    }
}
