        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.expr_type.as_ref() {
            match v {
                ...
                physical_expr_node::ExprType::ScalarRegexMatchExpr(v) => {
                    struct_ser.serialize_field("scalarRegexMatchExpr", v)?;
                }
            }
        }
        struct_ser.end()
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "scalarRegexMatchExpr" | "scalar_regex_match_expr" => Ok(GeneratedField::ScalarRegexMatchExpr),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
...
;
                        ...
                        GeneratedField::ScalarRegexMatchExpr => {
                            if expr_type__.is_some() {
                                return Err(serde::de::Error::duplicate_field("scalarRegexMatchExpr"));
                            }
                            expr_type__ = map_.next_value::<::std::option::Option<_>>()?.map(physical_expr_node::ExprType::ScalarRegexMatchExpr)
;
                        }
                    }
                }
...
impl serde::Serialize for PhysicalScalarRegexMatchExprNode {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("datafusion.PhysicalScalarRegexMatchExprNode", len)?;
        if self.negated {
            struct_ser.serialize_field("negated", &self.negated)?;
        }
        if self.case_insensitive {
...
impl<'de> serde::Deserialize<'de> for PhysicalScalarRegexMatchExprNode {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PhysicalScalarRegexMatchExprNode;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct datafusion.PhysicalScalarRegexMatchExprNode")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PhysicalScalarRegexMatchExprNode, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut negated__ = None;
                ...
                Ok(PhysicalScalarRegexMatchExprNode {
                    negated: negated__.unwrap_or_default(),
                    case_insensitive: case_insensitive__.unwrap_or_default(),
                    expr: expr__,
                    pattern: pattern__,
        ...
        deserializer.deserialize_struct("datafusion.PhysicalScalarRegexMatchExprNode", FIELDS, GeneratedVisitor)
    }
}
