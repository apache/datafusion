        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.partition_method.as_ref() {
            match v {
                ...
                partitioning::PartitionMethod::HashSelectionVector(v) => {
                    struct_ser.serialize_field("hashSelectionVector", v)?;
                }
            }
        }
        struct_ser.end()
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "hashSelectionVector" | "hash_selection_vector" => Ok(GeneratedField::HashSelectionVector),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
...
;
                        ...
                        GeneratedField::HashSelectionVector => {
                            if partition_method__.is_some() {
                                return Err(serde::de::Error::duplicate_field("hashSelectionVector"));
                            }
                            partition_method__ = map_.next_value::<::std::option::Option<_>>()?.map(partitioning::PartitionMethod::HashSelectionVector)
;
                        }
                    }
                }
...
impl serde::Serialize for PhysicalHashSelectionVectorRepartition {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("datafusion.PhysicalHashSelectionVectorRepartition", len)?;
        if !self.hash_expr.is_empty() {
            struct_ser.serialize_field("hashExpr", &self.hash_expr)?;
        }
        if self.partition_count != 0 {
...
impl<'de> serde::Deserialize<'de> for PhysicalHashSelectionVectorRepartition {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PhysicalHashSelectionVectorRepartition;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct datafusion.PhysicalHashSelectionVectorRepartition")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PhysicalHashSelectionVectorRepartition, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut hash_expr__ = None;
                ...
                Ok(PhysicalHashSelectionVectorRepartition {
                    hash_expr: hash_expr__.unwrap_or_default(),
                    partition_count: partition_count__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("datafusion.PhysicalHashSelectionVectorRepartition", FIELDS, GeneratedVisitor)
    }
}
