...
impl serde::Serialize for PhysicalExprList {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("datafusion.PhysicalExprList", len)?;
        if !self.exprs.is_empty() {
...
impl<'de> serde::Deserialize<'de> for PhysicalExprList {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = PhysicalExprList;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct datafusion.PhysicalExprList")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PhysicalExprList, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("datafusion.PhysicalExprList", FIELDS, GeneratedVisitor)
    }
}
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.physical_plan_type.as_ref() {
            match v {
                ...
                physical_plan_node::PhysicalPlanType::Values(v) => {
                    struct_ser.serialize_field("values", v)?;
                }
            }
        }
...
;
                        ...
                        GeneratedField::Values => {
                            ...
                            physical_plan_type__ = map_.next_value::<::std::option::Option<_>>()?.map(physical_plan_node::PhysicalPlanType::Values)
;
                        }
                    }
                }
