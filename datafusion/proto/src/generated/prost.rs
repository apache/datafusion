...
pub struct ScalarDictionaryValue {
    #[prost(message, optional, tag = "1")]
    pub index_type: ::core::option::Option<super::datafusion_common::ArrowType>,
    #[prost(message, optional, boxed, tag = "2")]
...
pub struct UnionValue {
    ...
    #[prost(enumeration = "super::datafusion_common::UnionMode", tag = "4")]
    pub mode: i32,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod scalar_value {
    ...
    pub enum Value {
        ...
        #[prost(message, tag = "33")]
        NullValue(super::super::datafusion_common::ArrowType),
        #[prost(bool, tag = "1")]
        BoolValue(bool),
        #[prost(string, tag = "2")]
