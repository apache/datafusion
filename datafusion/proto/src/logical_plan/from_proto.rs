...
use datafusion_common::{
    ...
    RecursionUnnestOption, Result, ScalarValue, Spans, TableReference, UnnestOptions,
};
...
use datafusion_expr::{ExprFunctionExt, Subquery, WriteOp};
...
use crate::protobuf::OuterReferenceColumn;
use crate::protobuf::{
    self,
