...
fn main() -> Result<(), String> {
    ...
    prost_build::Config::new()
        ...
        .out_dir("src")
        .field_attribute("PhysicalPlanNode.PhysicalPlanType.parquet_scan", "#[cfg(feature = \"parquet\")]")
        .field_attribute("PhysicalPlanNode.PhysicalPlanType.parquet_sink", "#[cfg(feature = \"parquet\")]")
        .field_attribute("ListingTableScanNode.FileFormatType.parquet", "#[cfg(feature = \"parquet\")]")
        .field_attribute("FileTypeWriterOptions.FileType.parquet_options", "#[cfg(feature = \"parquet\")]")
