...
PRINT_SCALAR_FUNCTION_DOCS_COMMAND="cargo run --manifest-path datafusion/core/Cargo.toml --bin print_scalar_functions_docs"
...
<!---
This file was generated by the dev/update_scalar_docs.sh script.
Do not edit it manually as changes will be overwritten.
Instead, edit the ScalarUDFImpl's documentation() function to
update documentation for an individual UDF or the
dev/update_scalar_docs.sh file for updating surrounding text.
-->
